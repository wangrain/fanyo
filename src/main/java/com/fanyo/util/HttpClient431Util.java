...
public class HttpClient431Util {
    ...
    public static String doPostContent(String dataContent, String contentType, String contentCharset, String resCharset, String url, int connTimeOut, int socketTimeOut){
       	CloseableHttpClient httpClient = getSingleSSLConnection(connTimeOut,socketTimeOut);
       	CloseableHttpResponse response = null;
        if(StringUtils.isEmpty(url)){
            return null;
        }
   ...
   * @return    页面内容
   */
  public static String doPost(Map<String,String> params, Map<String,String> header, String url, String reqCharset, String resCharset){
  	CloseableHttpClient httpClient = getSingleSSLConnection();
   	CloseableHttpResponse response = null;
      if(StringUtils.isEmpty(url)){
          return null;
	   ...
	   * @return    页面内容
	   */
	  public static String doDualSSLPost(Map<String,String> params, String cookie, String url, String reqCharset, String resCharset, String keyStorePath, String keyStorePass){
		  CloseableHttpClient httpClient = getDualSSLConnection(keyStorePath,keyStorePass);
	       	CloseableHttpResponse response = null;
	      if(StringUtils.isEmpty(url)){
	          return null;
	   ...
	   * @return
	   */
	  public static String getCookie(Map<String,String> params, String url, String reqCharset, String resCharset, String keyStorePath, String keyStorePass){
		  CloseableHttpClient httpClient = getDualSSLConnection(keyStorePath,keyStorePass);
	       	CloseableHttpResponse response = null;
	      try {
	          List<NameValuePair> pairs = null;
	...
	/**
	  ...
	  * @throws AppException
	  */
	private static CloseableHttpClient getSingleSSLConnection(int connTimeOut,int socketTimeOut) throws AppException{
	 	CloseableHttpClient httpClient = null;
	 	try {
				SSLContext sslContext = new SSLContextBuilder().loadTrustMaterial(null,new TrustStrategy() {
					@Override
